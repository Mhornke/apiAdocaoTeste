...
const nodemailer_1 = __importDefault(require("nodemailer")); // Importando nodemailer
const crypto_1 = __importDefault(require("crypto")); // Para gerar um código aleatório
...
async function enviaEmail(nome, email, descricao, resposta) {
...
router.post("/senha/solicitar-troca", async (req, res) => {
    ...
    try {
        ...
        const codigo = crypto_1.default.randomBytes(3).toString('hex'); // Gera um código de 6 caracteres
